 ...
 *
 * @final since Symfony 6.3 App\Utils\DateImmutableNormalizer
 */
class DateImmutableNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
     ...
     */
    public function denormalize(mixed $data, string $type, string $format = null, array $context = []): DateImmutable
    {
        ...
        try {
            ...
            if (null !== $dateTimeFormat) {
                $object = DateImmutable::createFromFormat($dateTimeFormat, $data, $timezone);

                if (false !== $object) {
                    return $object;
                }

                $dateTimeErrors =  DateImmutable::getLastErrors();
            ...
            if (null !== $defaultDateTimeFormat) {
                $object = DateImmutable::createFromFormat($defaultDateTimeFormat, $data, $timezone);
            ...
            return  new DateImmutable($data, $timezone);
    ...
    private function getTimezone(array $context): ?DateImmutable
    {
